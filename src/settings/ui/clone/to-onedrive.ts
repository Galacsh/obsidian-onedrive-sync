...
export default class CloneToOneDriveModal extends Modal {
	 ...
	 */
	private showTitle() {
		this.container.createEl("h3", { text: "Clone Local → OneDrive" });
	}
	...
	private showDescription() {
		this.container.createEl("p", {
			text: "This will clone your local vault to OneDrive vault.",
		});
	...
	private showHowItWorks() {
		...
		ol.createEl("li", {
			text: "This process will first delete all files in your OneDrive vault.",
		});
		ol.createEl("li", {
			text: "Then it will upload all files from your local vault.",
		});
		ol.createEl("li", {
	...
	private showCautions() {
		...
		ul.createEl("li", {
			text: 'This do not upload files in the "Ignore On Upload" list.',
		});
		ul.createEl("li", {
	...
	private showConfirmButton(div: HTMLDivElement) {
		...
		button.onclick = async () => {
			await this.plugin.oneDrive.cloneToOneDrive();
		};
	}
